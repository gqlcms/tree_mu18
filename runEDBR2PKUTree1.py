...
if __name__ == '__main__': 
    input_dir="/eos/cms/store/user/xulyu/data2016_3.10_correct_tau4/16/"
    treen="tree_sf_new/"
#    input_dir="/afs/cern.ch/user/l/lewang/eos/cms/store/user/lewang/toapproval_QCD_Wprime/"
    infile=open("filelist1.txt")
    ...
    for sample in totalsamples:
        if sample[0]!="#":
            ...
            if "singleEl" in samplename: 
                ...
                analyzer_mu=EDBR2PKUTree(treein,channel+"_out_"+samplename,IsData);

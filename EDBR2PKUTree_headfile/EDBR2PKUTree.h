...
//   Double_t         jet3_btag;
   ...
   //  Double_t jetAK8puppi_dnnDecorrW,jetAK8puppi_dnnDecorrW_2;
   Float_t jetAK8puppi_dnnDecorrW_f, jetAK8puppi_dnnDecorrW_2_f;
...
// exclusive AK4
double pt_AK4_ex_DR0p8[8],eta_AK4_ex_DR0p8[8],phi_AK4_ex_DR0p8[8],e_AK4_ex_DR0p8[8];
double_t pt_AK4_ex_DR0p8_JEC_up[8];
double_t pt_AK4_ex_DR0p8_JEC_down[8];
double_t pt_AK4_ex_DR0p8_JER_up[8];
double_t pt_AK4_ex_DR0p8_JER_down[8];
// exclusive AK4
...
double RelIso03_NewID;
float RelIso03_NewID_f;
int mvaFall17V2Iso_WP80;
double MET_et_new;
...
double MET_phi_new;
    ...
    TBranch        *b_RelIso03_NewID;   //!
    TBranch        *b_mvaFall17V2Iso_WP80;   //!
...
double weight_deep_lumi_nosft60,weight_deep_lumi_nosfq60,weight_deep_lumi_nosfw60,weight_deep_lumi_nosft100,weight_deep_lumi_nosfq100,weight_deep_lumi_nosfw100,weight_deep_lumi_nosft150,weight_deep_lumi_nosfq150,weight_deep_lumi_nosft200,weight_deep_lumi_nosfq200;
   ...
   Int_t           event;
   Double_t           Common_event_lepSF;
   Float_t           Common_event_lepSF_f;
   Int_t           Process_1Lep2fatjet_HLT_IsoMu24;
    Int_t           Lep1fatJet2_HLT_Mu50;
    Int_t           Lep1fatJet2_HLT_OldMu100;
    Int_t           Lep1fatJet2_HLT_TkMu100;
    Int_t           Lep1fatJet2_HLT_IsoMu27;
    Int_t           Lep1fatJet2_HLT_Ele27;
    Int_t           Lep1fatJet2_HLT_Ele32_WPTight_Gsf_L1DoubleEG;
    Int_t           Lep1fatJet2_HLT_Ele35_WPTight_Gsf;
    Int_t           Lep1fatJet2_HLT_Photon200;
    Int_t           Lep1fatJet2_HLT_Ele32_WPTight_Gsf;
...
//   Double_t        massVhad_gen;
   ...
   Double_t        metPhi;
   Double_t        theWeight;
   float        Common_genWeight;
   Double_t        nump;
   Double_t        numm;
   Double_t        npT;
   Float_t        npT_f;
   Int_t        Process_1Lep2fatjet_PassOldID;
   Int_t        Process_1Lep2fatjet_PassNewID;
   Double_t        npIT;
   Int_t           nBX;
...
double W_mass_resolved_1AK8,W_phi_resolved_1AK8,W_pt_resolved_1AK8,W_eta_resolved_1AK8;
double_t W_pt_resolved_1AK8_JEC_up;
double_t W_pt_resolved_1AK8_JEC_down;
double_t W_pt_resolved_1AK8_JER_up;
double_t W_pt_resolved_1AK8_JER_down;
double Z_mass_resolved_1AK8,Z_phi_resolved_1AK8,Z_pt_resolved_1AK8,Z_eta_resolved_1AK8;
double gen_W_mass_resolved_1AK8,gen_W_phi_resolved_1AK8,gen_W_pt_resolved_1AK8,gen_W_eta_resolved_1AK8;
double gen_Z_mass_resolved_1AK8,gen_Z_phi_resolved_1AK8,gen_Z_pt_resolved_1AK8,gen_Z_eta_resolved_1AK8;
double min_deltaR_resolved_1AK8,min_deltaR_first_AK4_resolved_1AK8,min_deltaR_second_AK4_resolved_1AK8,first_AK4_matched_gen_w_daughter_pt,first_AK4_matched_w_daughter_pt,second_AK4_matched_gen_w_daughter_pt,second_AK4_matched_w_daughter_pt;
double min_deltaR_resolved_1AK8_Z;
int resolved_AK4_id[2];
int  resolved_AK4_id_Z[2];
int gen_w_resolved_id;

double resolved_MJJlv;
double resolved_MJJlv_JEC_up;
double resolved_MJJlv_JEC_down;
double resolved_MJJlv_JER_up;
double resolved_MJJlv_JER_down;
...
int AK4_1_id_0AK8[2];
int AK4_2_id_0AK8[2];
double W_mass_resolved_1_0AK8, W_phi_resolved_1_0AK8,W_pt_resolved_1_0AK8,W_eta_resolved_1_0AK8,W_mass_resolved_2_0AK8,W_phi_resolved_2_0AK8,W_pt_resolved_2_0AK8,W_eta_resolved_2_0AK8;
double min_deltaR_resolved_w_1_0AK8, min_deltaR_resolved_w_2_0AK8;
double gen_w_1_resolved_id, gen_w_2_resolved_id;
double  gen_W_1_pt_resolved_0AK8, gen_W_2_pt_resolved_0AK8;

double    AK4_1_id_0AK8_Z[2];    
double    AK4_2_id_0AK8_Z[2];    
double        Z_mass_resolved_1_0AK8,    Z_phi_resolved_1_0AK8,    Z_pt_resolved_1_0AK8,    Z_eta_resolved_1_0AK8,    Z_mass_resolved_2_0AK8,    Z_phi_resolved_2_0AK8,    Z_pt_resolved_2_0AK8,    Z_eta_resolved_2_0AK8;
double min_deltaR_resolved_z_1_0AK8, min_deltaR_resolved_z_2_0AK8;
double gen_Z_1_resolved_id, gen_Z_2_resolved_id;
double  gen_Z_1_pt_resolved_0AK8, gen_Z_2_pt_resolved_0AK8;
...
// resolved case; 0 AK8
   ...
   Float_t        jetAK8puppi_ptJEC_f;
   Float_t        jetAK8puppi_eta_f;
   Float_t        jetAK8puppi_phi_f;
   Double_t        jetAK8puppi_sdcorr_f;
   
	Double_t        jetAK8puppi_sdJEC_2;
   Float_t        jetAK8puppi_sd_2_f;
   Double_t        jetAK8puppi_sd_2;
   Double_t        jetAK8puppi_tau21_2;
   Double_t        jetAK8puppi_tau42_2;
   Float_t        jetAK8puppi_ptJEC_2_f;
   Float_t        jetAK8puppi_eta_2_f;
   Float_t        jetAK8puppi_phi_2_f;
...
//   Double_t        delPhijetlepJEC;
   ...
   Double_t        ak4jet_pt_JEC_up[8];
   Double_t        ak4jet_pt_JEC_down[8];
   Double_t        ak4jet_pt_JER_up[8];
   Double_t        ak4jet_pt_JER_down[8];
    double          ak4jet_deepcsvb[8],ak4jet_deepcsvbb[8],ak4jet_deepcsvb_bb[8];
   Double_t        ak4jet_pt_uncorr[8];
   Double_t        ak4jet_eta[8];
  std::vector<float> *            ak4jet_pt_v=0;
  std::vector<float> *            ak4jet_eta_v=0;
  std::vector<float> *            ak4jet_phi_v=0;
  std::vector<float> *            ak4jet_e_v=0;
  std::vector<float> *            Jet_btagDeepB=0;
  //std::vector<Float_t> *            Common_LHEWeight_mg_reweighting=0;
  std::vector<float> *            Common_LHEWeight_mg_reweighting=0;
   ...
   TBranch        *b_Process_1Lep2fatjet_HLT_IsoMu24;   //!
    ...
    TBranch        *b_Lep1fatJet2_HLT_Ele27;
   ...
   TBranch        *b_nVtx;   //!
   TBranch        *b_theWeight;   //!
   TBranch        *b_Common_genWeight;   //!
   TBranch        *b_nump;   //!
   TBranch        *b_numm;   //!
   TBranch        *b_npT;   //!
   TBranch        *b_Process_1Lep2fatjet_PassOldID;   //!
   TBranch        *b_Process_1Lep2fatjet_PassNewID;   //!
   TBranch        *b_nLooseEle;   //!
   TBranch        *b_nLooseMu;   //!
   TBranch        *b_lep;   //!
   TBranch        *b_ptlep1;   //!
...
*/
   ...
   TString m_dataset;
   EDBR2PKUTree(TTree *tree=0, TString dataset="",Int_t IsData=0., Int_t numofevent = 1);
   ...
   void num_of_AK8_AK4();
   void BSF(Int_t);
   void weight_tau_or_deep_corr(TString channelname, Int_t IsData, double weight_tmp);
   void num_of_bJet();
   void Nsubjetness2();
   void ST_cal();
   void sd_corr();
   // void all_kinds_deltaR();
   // void all_kinds_deltaR_unknown();
   void Mj_oder();
   void MassVV_cal();
   void pt_order_consider_w();
   void in_and_ex_ak4();
   void find_boson_W();
   void resolved_w_boson_gen_w_matching();
   void resolved_w_boson_gen_w_daughter_matching();
   void find_boson_Z();
   void resolved_Z_boson_gen_Z_matching();
   void use_w_mass_resolved();
   void use_z_mass_resolved();
   void find_w_boson_0AK8();
   void resolved_w_boson_gen_w_matching_0AK8();
   void find_z_boson_0AK8();
   void resolved_z_boson_gen_z_matching_0AK8();
   void use_w_mass_resolved_0AK8();
   void use_z_mass_resolved_0AK8();
   void inv_mass();
   void two_w_boson_deltaR();
   void match_particle_for_each_jet(Int_t);
   void weight_dnn_corr(Int_t IsData, Double_t massdnn[5],TH1D *h_t60,TH1D *h_q60,TH1D *h_w60,TH1D *h_t100,TH1D *h_q100,TH1D *h_w100,TH1D *h_t150,TH1D *h_q150,TH1D *h_t200,TH1D *h_q200);
   void resolved_MJJlv_1AK8();
   void resolved_MJJlv_cal();
   void ForAK4_switchtoarray();
...
EDBR2PKUTree::EDBR2PKUTree(TTree *tree, TString dataset,Int_t IsData, Int_t numofevent) : fChain(0)
{
...
void EDBR2PKUTree::Init(TTree *tree,Int_t IsData)
{
   ...
   // fChain->SetBranchStatus("mvaFall17V2Iso_WP80",1);
   // fChain->SetBranchStatus("nLooseEle_NewID",1);
   // fChain->SetBranchStatus("nLooseMu_NewID",1);
   ...
   // fChain->SetBranchStatus("theWeight_NewID",1);
   fChain->SetBranchStatus("Common_event_lepSF",1);
   // fChain->SetBranchStatus("muisolation_NewID",1);
   // fChain->SetBranchStatus("jetAK8puppi_pt1",1);
   fChain->SetBranchStatus("Lep1fatJet2_jetAK8puppi_ptJEC",1);
   fChain->SetBranchStatus("Lep1fatJet2_jetAK8puppi_ptJECJER",1);
   fChain->SetBranchStatus("Lep1fatJet2_jetAK8puppi_eta",1);
   fChain->SetBranchStatus("Lep1fatJet2_jetAK8puppi_phi",1);
   fChain->SetBranchStatus("Lep1fatJet2_jetAK8puppi_sd",1);
   fChain->SetBranchStatus("Lep1fatJet2_jetAK8puppi_ptJEC_2",1);
   fChain->SetBranchStatus("Lep1fatJet2_jetAK8puppi_ptJECJER_2",1);
   fChain->SetBranchStatus("Lep1fatJet2_jetAK8puppi_eta_2",1);
   fChain->SetBranchStatus("Lep1fatJet2_jetAK8puppi_phi_2",1);
   fChain->SetBranchStatus("Lep1fatJet2_jetAK8puppi_sd_2",1);
   fChain->SetBranchStatus("Lep1fatJet2_jetAK8puppi_dnnDecorrW",1);
   fChain->SetBranchStatus("Lep1fatJet2_jetAK8puppi_dnnDecorrW_2",1);

   fChain->SetBranchStatus("Lep1fatJet2_Jet_pt_JER",1);
   ...
   fChain->SetBranchStatus("Common_genWeight",1);
   ...
   fChain->SetBranchStatus("Common_evt",1);
   fChain->SetBranchStatus("Lep1fatJet2_Pileup_nTrueInt",1);
   // fChain->SetBranchStatus("Process_1Lep2fatjet_PassOldID",1);
   // fChain->SetBranchStatus("Process_1Lep2fatjet_PassNewID",1);
   fChain->SetBranchStatus("Common_LHEWeight_mg_reweighting",1);
   fChain->SetBranchStatus("Common_event_lepSF",1);
   fChain->SetBranchStatus("Lep1fatJet2_HLT_IsoMu24",1);
    ...
    fChain->SetBranchStatus("Lep1fatJet2_HLT_Ele27",1);
...
//   ExTree->Branch("sdrop", &sdrop, "sdrop/D");
   ...
   ExTree->Branch("Common_event_lepSF",&Common_event_lepSF,"Common_event_lepSF/D");
   ExTree->Branch("Process_1Lep2fatjet_HLT_IsoMu24",&Process_1Lep2fatjet_HLT_IsoMu24,"Process_1Lep2fatjet_HLT_IsoMu24/I");
    ...
    ExTree->Branch("Lep1fatJet2_HLT_Ele27",&Lep1fatJet2_HLT_Ele27,"Lep1fatJet2_HLT_Ele27/I");
    ...
    ExTree->Branch("Lep1fatJet2_HLT_Ele32_WPTight_Gsf",&Lep1fatJet2_HLT_Ele32_WPTight_Gsf,"Lep1fatJet2_HLT_Ele32_WPTight_Gsf/I");
   ...
   ExTree->Branch("eff_and_pu_Weight", &eff_and_pu_Weight, "eff_and_pu_Weight/D");
   ...
   ExTree->Branch("MTVlep",&MTVlep,"MTVlep/D");
    ...
    ExTree->Branch("jetAK8puppi_sd",&jetAK8puppi_sd,"jetAK8puppi_sd/D");
    ExTree->Branch("jetAK8puppi_ptJEC_2",&jetAK8puppi_ptJEC_2,"jetAK8puppi_ptJEC_2/D");
    ...
    ExTree->Branch("jetAK8puppi_sd_2",&jetAK8puppi_sd_2,"jetAK8puppi_sd_2/D");
    ...
    ExTree->Branch("m_JJlv_JER_down",&m_JJlv_JER_down,"m_JJlv_JER_down/D");
        ...
        ExTree->Branch("Common_genWeight",&Common_genWeight,"Common_genWeight/F");
    ...
    if(IsData>0){
        ...
        //ExTree->Branch("pweight",pweight,"pweight[10]/F");
        ExTree->Branch("pweight",pweight,"pweight[10]/D");
...
//   ExTree->Branch("njets",&njets,"njets/I");
    ...
    */
    ...
    ExTree->Branch("resolved_MJJlv",&resolved_MJJlv,"resolved_MJJlv/D");
    ExTree->Branch("resolved_MJJlv_JEC_up",&resolved_MJJlv_JEC_up,"resolved_MJJlv_JEC_up/D");
    ExTree->Branch("resolved_MJJlv_JEC_down",&resolved_MJJlv_JEC_down,"resolved_MJJlv_JEC_down/D");
    ExTree->Branch("resolved_MJJlv_JER_up",&resolved_MJJlv_JER_up,"resolved_MJJlv_JER_up/D");
    ExTree->Branch("resolved_MJJlv_JER_down",&resolved_MJJlv_JER_down,"resolved_MJJlv_JER_down/D");

    ExTree->Branch("W_mass_resolved_1AK8",&W_mass_resolved_1AK8,"W_mass_resolved_1AK8/D");
    ExTree->Branch("Z_mass_resolved_1AK8",&Z_mass_resolved_1AK8,"Z_mass_resolved_1AK8/D");
    ExTree->Branch("W_pt_resolved_1AK8",&W_pt_resolved_1AK8,"W_pt_resolved_1AK8/D");
    ExTree->Branch("W_pt_resolved_1AK8_JEC_up",&W_pt_resolved_1AK8_JEC_up,"W_pt_resolved_1AK8_JEC_up/D");
    ExTree->Branch("W_pt_resolved_1AK8_JEC_down",&W_pt_resolved_1AK8_JEC_down,"W_pt_resolved_1AK8_JEC_down/D");
    ExTree->Branch("W_pt_resolved_1AK8_JER_up",&W_pt_resolved_1AK8_JER_up,"W_pt_resolved_1AK8_JER_up/D");
    ExTree->Branch("W_pt_resolved_1AK8_JER_down",&W_pt_resolved_1AK8_JER_down,"W_pt_resolved_1AK8_JER_down/D");
    ExTree->Branch("W_phi_resolved_1AK8",&W_phi_resolved_1AK8,"W_phi_resolved_1AK8/D");
    ExTree->Branch("W_eta_resolved_1AK8",&W_eta_resolved_1AK8,"W_eta_resolved_1AK8/D");
    ExTree->Branch("Z_pt_resolved_1AK8",&Z_pt_resolved_1AK8,"Z_pt_resolved_1AK8/D");
    ExTree->Branch("gen_W_pt_resolved_1AK8",&gen_W_pt_resolved_1AK8,"gen_W_pt_resolved_1AK8/D");
    ExTree->Branch("gen_Z_pt_resolved_1AK8",&gen_Z_pt_resolved_1AK8,"gen_Z_pt_resolved_1AK8/D");
    ExTree->Branch("min_deltaR_resolved_1AK8",&min_deltaR_resolved_1AK8,"min_deltaR_resolved_1AK8/D");
    ExTree->Branch("min_deltaR_resolved_1AK8_Z",&min_deltaR_resolved_1AK8_Z,"min_deltaR_resolved_1AK8_Z/D");
    ExTree->Branch("min_deltaR_first_AK4_resolved_1AK8",&min_deltaR_first_AK4_resolved_1AK8,"min_deltaR_first_AK4_resolved_1AK8/D");
    ExTree->Branch("min_deltaR_second_AK4_resolved_1AK8",&min_deltaR_second_AK4_resolved_1AK8,"min_deltaR_second_AK4_resolved_1AK8/D");
    ExTree->Branch("first_AK4_matched_gen_w_daughter_pt",&first_AK4_matched_gen_w_daughter_pt,"first_AK4_matched_gen_w_daughter_pt/D");
    ExTree->Branch("first_AK4_matched_w_daughter_pt",&first_AK4_matched_w_daughter_pt,"first_AK4_matched_w_daughter_pt/D");
    ExTree->Branch("second_AK4_matched_gen_w_daughter_pt",&second_AK4_matched_gen_w_daughter_pt,"second_AK4_matched_gen_w_daughter_pt/D");
    ExTree->Branch("second_AK4_matched_w_daughter_pt",&second_AK4_matched_w_daughter_pt,"second_AK4_matched_w_daughter_pt/D");
//    ExTree->Branch("",&,"/D");
    ExTree->Branch("min_deltaR_resolved_1AK8",&min_deltaR_resolved_1AK8,"min_deltaR_resolved_1AK8/D");


    ExTree->Branch("W_mass_resolved_1_0AK8",&W_mass_resolved_1_0AK8,"W_mass_resolved_1_0AK8/D");
    ExTree->Branch("W_pt_resolved_1_0AK8",&W_pt_resolved_1_0AK8,"W_pt_resolved_1_0AK8/D");
    ExTree->Branch("W_mass_resolved_2_0AK8",&W_mass_resolved_2_0AK8,"W_mass_resolved_2_0AK8/D");
    ExTree->Branch("W_pt_resolved_2_0AK8",&W_pt_resolved_2_0AK8,"W_pt_resolved_2_0AK8/D");
    ExTree->Branch("min_deltaR_resolved_w_1_0AK8",&min_deltaR_resolved_w_1_0AK8,"min_deltaR_resolved_w_1_0AK8/D");
    ExTree->Branch("min_deltaR_resolved_w_2_0AK8",&min_deltaR_resolved_w_2_0AK8,"min_deltaR_resolved_w_2_0AK8/D");
    ExTree->Branch("gen_W_1_pt_resolved_0AK8",&gen_W_1_pt_resolved_0AK8,"gen_W_1_pt_resolved_0AK8/D");
    ExTree->Branch("gen_W_2_pt_resolved_0AK8",&gen_W_2_pt_resolved_0AK8,"gen_W_2_pt_resolved_0AK8/D");
    ExTree->Branch("Z_mass_resolved_1_0AK8",&Z_mass_resolved_1_0AK8,"Z_mass_resolved_1_0AK8/D");
    ExTree->Branch("Z_pt_resolved_1_0AK8",&Z_pt_resolved_1_0AK8,"Z_pt_resolved_1_0AK8/D");
    ExTree->Branch("Z_mass_resolved_2_0AK8",&Z_mass_resolved_2_0AK8,"Z_mass_resolved_2_0AK8/D");
    ExTree->Branch("Z_pt_resolved_2_0AK8",&Z_pt_resolved_2_0AK8,"Z_pt_resolved_2_0AK8/D");
    ExTree->Branch("min_deltaR_resolved_z_1_0AK8",&min_deltaR_resolved_z_1_0AK8,"min_deltaR_resolved_z_1_0AK8/D");
    ExTree->Branch("min_deltaR_resolved_z_2_0AK8",&min_deltaR_resolved_z_2_0AK8,"min_deltaR_resolved_z_2_0AK8/D");
    ExTree->Branch("gen_Z_1_pt_resolved_0AK8",&gen_Z_1_pt_resolved_0AK8,"gen_Z_1_pt_resolved_0AK8/D");
    ExTree->Branch("gen_Z_2_pt_resolved_0AK8",&gen_Z_2_pt_resolved_0AK8,"gen_Z_2_pt_resolved_0AK8/D");
...
//   ExTree->Branch("corr",&corr,"corr/D");
   ...
   ExTree->Branch("RelIso03_NewID",&RelIso03_NewID,"RelIso03_NewID/D");
   ExTree->Branch("mvaFall17V2Iso_WP80",&mvaFall17V2Iso_WP80,"mvaFall17V2Iso_WP80/I");
   ...
   ExTree->Branch("MET_sumEt",&MET_sumEt,"MET_sumEt/D");
    ...
    ExTree->Branch("ak4jet_pt_JEC_up",&ak4jet_pt_JEC_up,"ak4jet_pt_JEC_up[8]/D");
    ExTree->Branch("ak4jet_pt_JEC_down",&ak4jet_pt_JEC_down,"ak4jet_pt_JEC_down[8]/D");
    ExTree->Branch("ak4jet_pt_JER_up",&ak4jet_pt_JER_up,"ak4jet_pt_JER_up[8]/D");
    ExTree->Branch("ak4jet_pt_JER_down",&ak4jet_pt_JER_down,"ak4jet_pt_JER_down[8]/D");
   ...
   fChain->SetBranchAddress("Common_evt", &event, &b_event);
   fChain->SetBranchAddress("Common_event_lepSF", &Common_event_lepSF_f, &b_Common_event_lepSF);
   fChain->SetBranchAddress("Lep1fatJet2_HLT_IsoMu24", &Process_1Lep2fatjet_HLT_IsoMu24, &b_Process_1Lep2fatjet_HLT_IsoMu24);
    ...
    fChain->SetBranchAddress("Lep1fatJet2_HLT_Ele27", &Lep1fatJet2_HLT_Ele27, &b_Lep1fatJet2_HLT_Ele27);
   ...
   fChain->SetBranchAddress("Lep1fatJet2_LeptonPDGID", &lep, &b_lep);
   fChain->SetBranchAddress("channel", &channel, &b_channel);
   fChain->SetBranchAddress("Lep1fatJet2_LeptonPt", &ptlep1_f, &b_ptlep1);
   fChain->SetBranchAddress("Lep1fatJet2_NeutrinoPt", &ptlep2_f, &b_ptlep2);
   fChain->SetBranchAddress("Lep1fatJet2_LeptonEta", &etalep1_f, &b_etalep1);
   fChain->SetBranchAddress("Lep1fatJet2_NeutrinoEta", &etalep2_f, &b_etalep2);
   fChain->SetBranchAddress("Lep1fatJet2_LeptonPhi", &philep1_f, &b_philep1);
   fChain->SetBranchAddress("Lep1fatJet2_Neutrinophi", &philep2_f, &b_philep2);
   // fChain->SetBranchAddress("met", &met, &b_met);
   // fChain->SetBranchAddress("metPhi", &metPhi, &b_metPhi);
   fChain->SetBranchAddress("theWeight", &theWeight, &b_theWeight);
   fChain->SetBranchAddress("Common_genWeight", &Common_genWeight, &b_Common_genWeight);
   fChain->SetBranchAddress("Lep1fatJet2_Pileup_nTrueInt", &npT_f, &b_npT);
   if(IsData!=0){
   fChain->SetBranchAddress("Common_MET_pt_JER", &MET_et_f, &b_MET_et);
   fChain->SetBranchAddress("Common_MET_phi_JER", &MET_phi, &b_MET_phi);
   }
   else{
   fChain->SetBranchAddress("Lep1fatJet2_MET_pt", &MET_et_f, &b_MET_et);
   fChain->SetBranchAddress("Lep1fatJet2_MET_phi", &MET_et_f, &b_MET_et);
   }
   fChain->SetBranchAddress("Lep1fatJet2_Muon_pfRelIso04_all", &RelIso03_NewID_f, &b_RelIso03_NewID);
   
  
   fChain->SetBranchAddress("Lep1fatJet2_LeptonicWPt", &ptVlepJEC_f, &b_ptVlepJEC);
   fChain->SetBranchAddress("Lep1fatJet2_LeptonicWEta", &yVlepJEC_f, &b_yVlepJEC);
   fChain->SetBranchAddress("Lep1fatJet2_LeptonicWPhi", &phiVlepJEC_f, &b_phiVlepJEC);
   fChain->SetBranchAddress("Lep1fatJet2_LeptonicWM", &massVlepJEC_f, &b_massVlepJEC);
   fChain->SetBranchAddress("Lep1fatJet2_LeptonicWMt", &mtVlepJEC_f, &b_mtVlepJEC);

 
   
   if(IsData!=0){
      fChain->SetBranchAddress("Lep1fatJet2_jetAK8puppi_ptJECJER", &jetAK8puppi_ptJEC_f, &b_jetAK8puppi_ptJEC);
      fChain->SetBranchAddress("Lep1fatJet2_jetAK8puppi_ptJECJER_2", &jetAK8puppi_ptJEC_2_f, &b_jetAK8puppi_ptJEC_2);
   }
   else{
      fChain->SetBranchAddress("Lep1fatJet2_jetAK8puppi_ptJEC", &jetAK8puppi_ptJEC_f, &b_jetAK8puppi_ptJEC);
      fChain->SetBranchAddress("Lep1fatJet2_jetAK8puppi_ptJEC_2", &jetAK8puppi_ptJEC_2_f, &b_jetAK8puppi_ptJEC_2);
   }
   fChain->SetBranchAddress("Lep1fatJet2_jetAK8puppi_eta", &jetAK8puppi_eta_f, &b_jetAK8puppi_eta);
   fChain->SetBranchAddress("Lep1fatJet2_jetAK8puppi_phi", &jetAK8puppi_phi_f, &b_jetAK8puppi_phi);
   fChain->SetBranchAddress("Lep1fatJet2_jetAK8puppi_sd", &jetAK8puppi_sd_f, &b_jetAK8puppi_sd);
   fChain->SetBranchAddress("Lep1fatJet2_jetAK8puppi_sd_2", &jetAK8puppi_sd_2_f, &b_jetAK8puppi_sd_2);
   fChain->SetBranchAddress("Lep1fatJet2_jetAK8puppi_eta_2", &jetAK8puppi_eta_2_f, &b_jetAK8puppi_eta_2);
   fChain->SetBranchAddress("Lep1fatJet2_jetAK8puppi_phi_2", &jetAK8puppi_phi_2_f, &b_jetAK8puppi_phi_2);
   fChain->SetBranchAddress("Lep1fatJet2_jetAK8puppi_dnnDecorrW", &jetAK8puppi_dnnDecorrW_f  , &b_jetAK8puppi_dnnDecorrW  );
   fChain->SetBranchAddress("Lep1fatJet2_jetAK8puppi_dnnDecorrW_2", &jetAK8puppi_dnnDecorrW_2_f  , &b_jetAK8puppi_dnnDecorrW_2  );


   
   fChain->SetBranchAddress("Lep1fatJet2_Jet_pt_JER", &ak4jet_pt_v);
   fChain->SetBranchAddress("Lep1fatJet2_Jet_eta",  &ak4jet_eta_v);
   fChain->SetBranchAddress("Lep1fatJet2_Jet_phi", &ak4jet_phi_v);
   fChain->SetBranchAddress("Lep1fatJet2_Jet_e",  &ak4jet_e_v);
   fChain->SetBranchAddress("Lep1fatJet2_Jet_btagDeepB",  &Jet_btagDeepB);


   fChain->SetBranchAddress("Common_LHEWeight_mg_reweighting",  &Common_LHEWeight_mg_reweighting);


// fChain->SetBranchAddress("Lep1fatJet2_Jet_hadronFlavour", ak4jet_hf, &b_ak4jet_hf);
//    fChain->SetBranchAddress("Lep1fatJet2_Jet_partonFlavour", ak4jet_pf, &b_ak4jet_pf);
   // fChain->SetBranchAddress("jetAK8puppi_dnnTop_NewID", &jetAK8puppi_dnnTop, &b_jetAK8puppi_dnnTop);
   // fChain->SetBranchAddress("jetAK8puppi_dnnW_NewID", &jetAK8puppi_dnnW  , &b_jetAK8puppi_dnnW  );
   // fChain->SetBranchAddress("jetAK8puppi_dnnH4q_NewID", &jetAK8puppi_dnnH4q, &b_jetAK8puppi_dnnH4q);
   // fChain->SetBranchAddress("jetAK8puppi_dnnTop_2_NewID", &jetAK8puppi_dnnTop_2, &b_jetAK8puppi_dnnTop_2);
   // fChain->SetBranchAddress("jetAK8puppi_dnnW_2_NewID", &jetAK8puppi_dnnW_2  , &b_jetAK8puppi_dnnW_2  );
   // fChain->SetBranchAddress("jetAK8puppi_dnnH4q_2_NewID", &jetAK8puppi_dnnH4q_2, &b_jetAK8puppi_dnnH4q_2);
   // fChain->SetBranchAddress("jetAK8puppi_dnnTop_3_NewID", &jetAK8puppi_dnnTop_3, &b_jetAK8puppi_dnnTop_3);
   // fChain->SetBranchAddress("jetAK8puppi_dnnW_3_NewID", &jetAK8puppi_dnnW_3  , &b_jetAK8puppi_dnnW_3  );
   // fChain->SetBranchAddress("jetAK8puppi_dnnH4q_3_NewID", &jetAK8puppi_dnnH4q_3, &b_jetAK8puppi_dnnH4q_3);
   // fChain->SetBranchAddress("jetAK8puppi_dnnDecorrTop_NewID", &jetAK8puppi_dnnDecorrTop, &b_jetAK8puppi_dnnDecorrTop);
   //   fChain->SetBranchAddress("jetAK8puppi_dnnDecorrH4q_NewID", &jetAK8puppi_dnnDecorrH4q, &b_jetAK8puppi_dnnDecorrH4q);
   // fChain->SetBranchAddress("jetAK8puppi_dnnDecorrTop_2_NewID", &jetAK8puppi_dnnDecorrTop_2, &b_jetAK8puppi_dnnDecorrTop_2);
   // fChain->SetBranchAddress("jetAK8puppi_dnnDecorrH4q_2_NewID", &jetAK8puppi_dnnDecorrH4q_2, &b_jetAK8puppi_dnnDecorrH4q_2);
   // fChain->SetBranchAddress("jetAK8puppi_dnnDecorrTop_3_NewID", &jetAK8puppi_dnnDecorrTop_3, &b_jetAK8puppi_dnnDecorrTop_3);
   // fChain->SetBranchAddress("jetAK8puppi_dnnDecorrW_3_NewID", &jetAK8puppi_dnnDecorrW_3  , &b_jetAK8puppi_dnnDecorrW_3  );
   // fChain->SetBranchAddress("jetAK8puppi_dnnDecorrH4q_3_NewID", &jetAK8puppi_dnnDecorrH4q_3, &b_jetAK8puppi_dnnDecorrH4q_3);
    
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrbb_NewID", &jetAK8puppi_dnnDecorrbb, &b_jetAK8puppi_dnnDecorrbb);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrbbnog_NewID", &jetAK8puppi_dnnDecorrbbnog, &b_jetAK8puppi_dnnDecorrbbnog);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrcc_NewID", &jetAK8puppi_dnnDecorrcc, &b_jetAK8puppi_dnnDecorrcc);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrccnog_NewID", &jetAK8puppi_dnnDecorrccnog, &b_jetAK8puppi_dnnDecorrccnog);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrbb_2_NewID", &jetAK8puppi_dnnDecorrbb_2, &b_jetAK8puppi_dnnDecorrbb_2);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrbbnog_2_NewID", &jetAK8puppi_dnnDecorrbbnog_2, &b_jetAK8puppi_dnnDecorrbbnog_2);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrcc_2_NewID", &jetAK8puppi_dnnDecorrcc_2, &b_jetAK8puppi_dnnDecorrcc_2);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrccnog_2_NewID", &jetAK8puppi_dnnDecorrccnog_2, &b_jetAK8puppi_dnnDecorrccnog_2);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrbb_3_NewID", &jetAK8puppi_dnnDecorrbb_3, &b_jetAK8puppi_dnnDecorrbb_3);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrbbnog_3_NewID", &jetAK8puppi_dnnDecorrbbnog_3, &b_jetAK8puppi_dnnDecorrbbnog_3);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrcc_3_NewID", &jetAK8puppi_dnnDecorrcc_3, &b_jetAK8puppi_dnnDecorrcc_3);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrccnog_3_NewID", &jetAK8puppi_dnnDecorrccnog_3, &b_jetAK8puppi_dnnDecorrccnog_3);

   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrqcd_NewID", &jetAK8puppi_dnnDecorrqcd, &b_jetAK8puppi_dnnDecorrqcd);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrtop_NewID", &jetAK8puppi_dnnDecorrtop, &b_jetAK8puppi_dnnDecorrtop);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrz_NewID", &jetAK8puppi_dnnDecorrz, &b_jetAK8puppi_dnnDecorrz);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrw_NewID", &jetAK8puppi_dnnDecorrw, &b_jetAK8puppi_dnnDecorrw);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrzbb_NewID", &jetAK8puppi_dnnDecorrzbb, &b_jetAK8puppi_dnnDecorrzbb);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrhbb_NewID", &jetAK8puppi_dnnDecorrhbb, &b_jetAK8puppi_dnnDecorrhbb);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrh4q_NewID", &jetAK8puppi_dnnDecorrh4q, &b_jetAK8puppi_dnnDecorrh4q);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrqcd_2_NewID", &jetAK8puppi_dnnDecorrqcd_2, &b_jetAK8puppi_dnnDecorrqcd_2);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrtop_2_NewID", &jetAK8puppi_dnnDecorrtop_2, &b_jetAK8puppi_dnnDecorrtop_2);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrz_2_NewID", &jetAK8puppi_dnnDecorrz_2, &b_jetAK8puppi_dnnDecorrz_2);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrw_2_NewID", &jetAK8puppi_dnnDecorrw_2, &b_jetAK8puppi_dnnDecorrw_2);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrzbb_2_NewID", &jetAK8puppi_dnnDecorrzbb_2, &b_jetAK8puppi_dnnDecorrzbb_2);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrhbb_2_NewID", &jetAK8puppi_dnnDecorrhbb_2, &b_jetAK8puppi_dnnDecorrhbb);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrh4q_2_NewID", &jetAK8puppi_dnnDecorrh4q_2, &b_jetAK8puppi_dnnDecorrh4q_2);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrqcd_3_NewID", &jetAK8puppi_dnnDecorrqcd_3, &b_jetAK8puppi_dnnDecorrqcd_3);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrtop_3_NewID", &jetAK8puppi_dnnDecorrtop_3, &b_jetAK8puppi_dnnDecorrtop_3);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrz_3_NewID", &jetAK8puppi_dnnDecorrz_3, &b_jetAK8puppi_dnnDecorrz_3);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrw_3_NewID", &jetAK8puppi_dnnDecorrw_3, &b_jetAK8puppi_dnnDecorrw_3);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrzbb_3_NewID", &jetAK8puppi_dnnDecorrzbb_3, &b_jetAK8puppi_dnnDecorrzbb_3);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrhbb_3_NewID", &jetAK8puppi_dnnDecorrhbb_3, &b_jetAK8puppi_dnnDecorrhbb);
   //  fChain->SetBranchAddress("jetAK8puppi_dnnDecorrh4q_3_NewID", &jetAK8puppi_dnnDecorrh4q_3, &b_jetAK8puppi_dnnDecorrh4q_3);
...
//     fChain->SetBranchAddress("jetAK8puppi_sd_3_NewID", &jetAK8puppi_sd_3, &b_jetAK8puppi_sd_3);
...
//     fChain->SetBranchAddress("jetAK8puppi_eta_3_NewID", &jetAK8puppi_eta_3, &b_jetAK8puppi_eta_3);
//     fChain->SetBranchAddress("jetAK8puppi_phi_3_NewID", &jetAK8puppi_phi_3, &b_jetAK8puppi_phi_3);
